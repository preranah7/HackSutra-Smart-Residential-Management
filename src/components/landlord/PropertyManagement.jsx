  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900 mb-1">Property Management</h1>
      ...
      {properties.length === 0 ? (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
          ...
          <h3 className="text-base font-semibold text-gray-900 mb-2">No Properties Yet</h3>
          <p className="text-sm text-gray-600 mb-6">
            Add your first property to start managing your real estate portfolio
          </p>
          <button
            onClick={() => setShowModal(true)}
            className="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors font-medium text-sm inline-flex items-center gap-2"
          >
            <Plus className="w-4 h-4" />
            Add First Property
          </button>
          ...
          {properties.map(property => {
            ...
            return (
              <div key={property.id} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
                {/* Property Header */}
                <div className={`p-4 ${isOccupied ? ' border-b border-emerald-100' : 'bg-gray-50 border-b border-gray-100'}`}>
                  <div className="flex justify-between items-start">
                    <div>
                      <h3 className="text-base font-semibold text-gray-900">{property.flatNumber}</h3>
                      <p className="text-xs text-gray-600">{property.bhk} BHK {property.propertyType}</p>
                    </div>
                ...
                <div className="p-5">
                  ...
                  {/* Tenant Info */}
                  {isOccupied ? (
                    <div className=" rounded-lg p-3 mb-3 border border-emerald-200">
                      <div className="flex items-center gap-2 mb-1.5">
                        <User className="w-3.5 h-3.5 text-emerald-700" />
                        <span className="font-medium text-emerald-900 text-xs">Current Tenant</span>
                      </div>
                      <p className="text-xs text-emerald-800 font-medium">{property.tenant}</p>
                      <p className="text-xs text-emerald-700">{property.tenantEmail}</p>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-2 bg-gray-400 hover:bg-red-600 text-white rounded-lg transition-colors"
                    >
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handlePropertySubmit} className="p-6 space-y-5">
              {/* Basic Details */}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full p-6">
            <div className="flex justify-between items-center mb-5">
              <div>
                <h2 className="text-xl font-semibold text-gray-900">Assign Tenant</h2>
                <p className="text-sm text-gray-600">Property: {selectedProperty.flatNumber}</p>
              </div>
              <button
                onClick={() => {
                  setShowTenantModal(false);
