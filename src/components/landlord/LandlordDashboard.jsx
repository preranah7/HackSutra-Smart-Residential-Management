...
import {
  ...
  Car, Trash2, AlertCircle, Building2
} from 'lucide-react';
      ...
      <div className="w-72 bg-white shadow-sm min-h-screen flex flex-col">
        <div className="p-6 flex-1">
          ...
          <div className="flex items-center gap-3 mb-8 pb-6 border-b border-gray-200">
            ...
            <div>
              <h2 className="font-semibold text-gray-900 text-base">Landlord Portal</h2>
        ...
        {activeSection === 'overview' && (
          <div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-6">Your Properties</h2>
              {properties.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors font-medium text-sm"
                  >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {properties.map(property => {
                    ...
                    return (
                      <div key={property.id} className="bg-white border border-gray-200 rounded-lg p-5 hover:shadow-md transition-shadow">
